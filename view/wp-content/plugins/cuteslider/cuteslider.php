...
/********************************************************/
	...
	function cuteslider_enqueue_content_res() {
		...
		wp_enqueue_script('respond', 'http://cdnjs.cloudflare.com/ajax/libs/respond.js/1.1.0/respond.min.js', array(), '1.1.0' );

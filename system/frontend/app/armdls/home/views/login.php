                ...
                <div class="panel-body">
                    <form class="form-horizontal m-t-20" method="post" action="<?php echo base_url(''); ?>home/index">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" name="user[c_email]" type="text" required="" placeholder="Email">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="user[c_password]" type="password" required="" placeholder="Password">
                            </div>
                        </div>

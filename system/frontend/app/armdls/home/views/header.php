                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="hidden-xs">
                                    <a href="<?php echo base_url(''); ?>home/logout"><i class="ti-power-off m-r-10 text-danger"></i> Logout</a>
                                </li>                                
                            </ul>
                        </div>
                        <!--/.nav-collapse -->
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="<?php echo base_url(''); ?>home/checkout" class="waves-effect"><i class="ti-shopping-cart"></i><span> Pembayaran Pesanan</span></a>
                            </li>
                        </ul>

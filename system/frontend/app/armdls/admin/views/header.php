            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo base_url(''); ?>admin/landing" class="logo"><i class="icon-magnet icon-c-logo"></i><span>GOOL FUTSAL</span></a>
                        <!-- Image Logo here -->
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="<?php echo base_url(''); ?>admin/checkout" class="waves-effect"><i class="ti-shopping-cart"></i><span> Pembayaran Pesanan </span></a>
                            </li>
                            <li class="has_sub">
                                <a href="<?php echo base_url(''); ?>admin/paymentlist" class="waves-effect"><i class="ti-menu-alt"></i><span> Daftar Pemesanan </span></a>
                            </li>
                        </ul>
